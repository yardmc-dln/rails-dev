class PostsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @post.save
        format.html { redirect_to @post, notice: 'Başarıyla Oluşturuldu.' }
  ...
  def update
    respond_to do |format|
      if @post.update(post_params)
        format.html { redirect_to @post, notice: 'Güncelleme başarılı.' }
  ...
  def destroy
    @post.destroy
    respond_to do |format|
      format.html { redirect_to posts_url, notice: 'Silindi.' }
